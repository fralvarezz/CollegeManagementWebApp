...
//Constructor de la clase
		function __construct($lista,$datos){
			$this->datos = $datos; //todos los datos de edificios de ls bd
			$this->lista = $lista; //nombre de las columnas de edificios de la bd
			$this->render();
		}
...
?>
            <h1><div class="trn">SHOWALL</div> <div class="trn">EDIFICIO</div></h1>
			<br>
			<br>
			<a href='../Controller/EDIFICIO_Controller.php?action=ADD'><i class="fas fa-plus" style="color:green"></i></a>
			<a href='../Controller/EDIFICIO_Controller.php?action=SEARCH'><i class="fas fa-search"></i></a>
...
?>
				<td>
					...
					<a href='
						../Controller/CENTRO_Controller.php?action=SHOWALL&codedificio=
							<?php echo $fila['CODEDIFICIO']; ?>
							'> <i class="fas fa-school"></i> </a>

					<a href='
						../Controller/ESPACIO_Controller.php?action=SHOWALL&codedificio=
							<?php echo $fila['CODEDIFICIO']; ?>
