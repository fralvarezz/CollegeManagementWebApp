<?php
/*
Vista de SHOWCURRENT de PROF_TITULACION
Hecho por: xa8678
04/10/2019
*/
...
//Mostrar html por pantalla
		...
		?>
            <h1><div class="trn">SHOWCURRENT</div> <div class="trn">PROF_TITULACION</div></h1>
			...
			<form name = 'Form' action='../Controller/PROF_TITULACION_Controller.php' method='post'>
				...
				<label class="trn" for='ANHOACADEMICO'>ANHOACADEMICO</label> <input type = 'text' name = 'ANHOACADEMICO' id = 'anhoacademico' placeholder = '' size = '10' value = '<?php echo $this->tupla['ANHOACADEMICO'];?>' readonly><br>
