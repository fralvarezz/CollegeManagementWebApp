<?php
/*
Vista de SHOWALL de PROF_TITULACION
Hecho por: xa8678
04/10/2019
*/
...
//Constructor de la clase
		function __construct($lista,$datos){
			$this->datos = $datos; //todos los datos de proftitulacion de ls bd
			$this->lista = $lista; //nombre de las columnas de proftitulacion de la bd
			$this->render();
		}
...
?>
            <h1><div class="trn">SHOWALL</div> <div class="trn">PROF_TITULACION</div></h1>
			<br>
			<br>
			<a href='../Controller/PROF_TITULACION_Controller.php?action=ADD'><i class="fas fa-plus" style="color:green"></i></a>
			<a href='../Controller/PROF_TITULACION_Controller.php?action=SEARCH'><i class="fas fa-search"></i></a>
