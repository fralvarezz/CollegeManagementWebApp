<?php
/*
Vista de SHOWCURRENT de CENTRO
Hecho por: xa8678
04/10/2019
*/
//Vista de SHOWCURRENT de CENTRO
...
//Mostrar html por pantalla
		...
		?>
            <h1><div class="trn">SHOWCURRENT</div> <div class="trn">CENTRO</div></h1>
			...
			<form name = 'Form' action='../Controller/CENTRO_Controller.php' method='post' >
				...
				<input type = 'text' name = 'CODCENTRO' id = 'codcentro' placeholder = '' size = '10' value = '<?php echo $this->tupla['CODCENTRO']; ?>' readonly><br>
